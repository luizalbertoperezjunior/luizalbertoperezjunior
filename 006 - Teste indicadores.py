...
indicadores_desejados = [
    ...
    # Adicione "RSI" à lista de indicadores desejados
...
for empresa in empresas:
    ...
    caminho_diretorio = f'C:/Users/luizp/OneDrive/Documentos/PythonScripts/finan/Finan/teste_{data_atual}'
    ...
    with pd.ExcelWriter(f'{caminho_diretorio}/{empresa}.xlsx') as writer:
